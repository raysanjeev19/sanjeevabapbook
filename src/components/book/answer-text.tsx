...
/* ABAP-flavoured keywords that are auto-bolded inline */
const ABAP_KEYWORDS = /\b(DATA:|TYPES:|FIELD-SYMBOLS:|SELECT|INTO|FROM|WHERE|LOOP AT|ENDLOOP|IF|ENDIF|PERFORM|CALL FUNCTION|CALL METHOD|CREATE OBJECT|TRY|CATCH|ENDTRY|APPEND|READ TABLE|MODIFY|DELETE|INSERT|CLEAR|FREE|REFRESH|ENQUEUE|DEQUEUE|COMMIT WORK|ROLLBACK WORK|MESSAGE|AUTHORITY-CHECK|SUBMIT|WRITE|NEW-LINE|AT SELECTION-SCREEN|START-OF-SELECTION|END-OF-SELECTION|GET|FORM|ENDFORM|FUNCTION|ENDFUNCTION|CLASS|ENDCLASS|METHOD|ENDMETHOD|INTERFACE|ENDINTERFACE|DEFINE VIEW|@|ASSOCIATION|COMPOSITION)\b/g;
