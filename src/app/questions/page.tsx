      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full appearance-none rounded-xl border border-border py-2.5 pl-9 pr-8 text-sm text-foreground outline-none sm:w-auto"
            >
        ...
        {filteredQuestions.length === 0 && (
          <div className="mt-16 text-center">
            ...
            <p className="mt-3 text-sm text-muted">No questions found. Try different keywords.</p>
          </div>
        )}
      </div>
    </main>
