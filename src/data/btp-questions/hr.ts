...
export const hrQuestions: BtpQuestion[] = [
  {
    ...
    realProjectExample:
      "A strong answer: 'I'm a CAP developer with two years building side-by-side extensions for S/4HANA — most recently a multitenant approval workflow app using RAP and CAP integration. I'm interested in this role because it involves scaling exactly that kind of multitenant SaaS architecture, which is where I want to deepen my expertise.'",
    interviewTip:
  ...
  },
  {
    ...
    detailedAnswer:
      "The strongest achievement answers have a clear 'so what' — a measurable outcome that mattered to the business or the team, not just a personal learning milestone. Structure it similarly to STAR: brief context, your specific action, and the quantified or clearly impactful result ('reduced manual approval time from 3 days to same-day', 'the multitenant architecture I designed now serves 40 customers from one deployment'). Ideally, pick an achievement that connects to a skill genuinely relevant to the role you're interviewing for — if the role emphasizes performance optimization, lead with a performance-related achievement rather than an unrelated one, even if both are genuinely proud moments.",
    hindiExplanation:
      "Sabse strong achievement answers mein ek clear 'so what' hota hai — ek measurable outcome jo business ya team ke liye matter karta hai, sirf personal learning milestone nahi. Ise STAR jaisa hi structure karo: brief context, tumhara specific action, aur quantified ya clearly impactful result ('manual approval time 3 din se same-day kar diya', 'jo multitenant architecture maine design kiya wo ab 40 customers ko ek hi deployment se serve karta hai'). Ideally, ek aisa achievement choose karo jo us role se relevant skill se connect ho jispe tum interview de rahe ho.",
    interviewExplanation:
      "I'd give a specific, quantified example: 'I'm proud of designing the multitenant architecture for our SaaS product — I specifically implemented the tenant-onboarding automation via SaaS Provisioning callbacks, which took onboarding time from a full day of manual setup to under a minute, now serving over 40 customers from one deployment.'",
    diagramNote:
      "'Context (brief)' → 'Your specific action' → 'Quantified/clear impact (business or technical)' — pick one relevant to the role's emphasis.",
    diagramMermaid: `flowchart LR
    A["Context (brief)"] --> B["Your specific action"] --> C["Quantified/clear impact"]`,
    realProjectExample:
      "'I designed and implemented an event-driven integration replacing a nightly batch sync between two systems — it cut data latency from up to 24 hours down to under a minute, which directly enabled a new real-time reporting feature the business had been asking for.'",
    interviewTip:
  ...
  },
  {
    ...
    detailedAnswer:
      "A weak answer either claims you were always right and the other person simply came around, or paints yourself as a pushover who abandoned your position without any real advocacy. A strong answer shows a genuine disagreement (e.g. 'I favored composition, a teammate favored a plain association for a specific relationship'), explains how you advocated with reasoning or evidence rather than just repeating your opinion louder, describes how resolution actually happened (a prototype comparison, data, a senior review, or you being genuinely persuaded by their point), and reflects honestly on what you learned — this shows maturity and collaborative skill, which is exactly what's being tested, not who was 'right'.",
    hindiExplanation:
      "Ek weak answer ya toh claim karta hai ki tum hamesha sahi the aur doosra person bas mann gaya, ya khud ko ek pushover ki tarah paint karta hai jisne bina real advocacy ke apni position abandon kar di. Ek strong answer ek genuine disagreement dikhata hai (jaise 'main composition favor karta tha, ek teammate ek plain association favor karta tha ek specific relationship ke liye'), explain karta hai ki tumne kaise reasoning/evidence se advocate kiya, describe karta hai resolution actually kaise hua (ek prototype comparison, data, ya tum genuinely unke point se persuade hue), aur honestly reflect karta hai ki tumne kya seekha.",
    interviewExplanation:
      "I'd frame it honestly: 'A teammate and I disagreed on whether a relationship should be a composition or association. I explained the ownership/lifecycle reasoning behind my preference, they raised a valid point about a case I hadn't considered, and we settled it by prototyping both quickly and comparing. We landed on their approach for that specific case, and I learned to weigh lifecycle implications more carefully before defaulting to my initial instinct.'",
    diagramNote:
      "'Genuine disagreement (specific technical point)' → 'Advocated with reasoning/evidence' → 'Resolution (data, prototype, or genuine persuasion)' → 'What you learned'.",
    diagramMermaid: `flowchart LR
    A["Genuine disagreement<br/>specific technical point"] --> B["Advocated with reasoning/evidence"]
    B --> C["Resolution: data, prototype,<br/>or genuine persuasion"]
    C --> D["What you learned"]`,
    realProjectExample:
      "'I believed a specific API endpoint should be a function (read-only) rather than an action, since it only calculated a value with no side effects. A teammate had already implemented it as an action. I explained the OData semantic difference and the caching implications, we discussed it, and they agreed to change it — a good example of a small but correct technical point worth raising clearly rather than letting slide.'",
    interviewTip:
  ...
  },
  {
    ...
    detailedAnswer:
      "Many candidates freeze on this question assuming leadership requires having managed people, but for early-career roles, interviewers are looking for signs of initiative and ownership beyond your assigned tasks. Strong examples include: noticing the team lacked a clear pattern for something (like error handling) and proactively proposing and documenting one; mentoring a newer teammate through a concept without being asked to; identifying a recurring production issue nobody had prioritized and driving the fix yourself; or facilitating a decision when the team was stuck between options. The key elements are: you noticed something needed doing, you acted without being told to, and there was a positive outcome from your initiative.",
    hindiExplanation:
      "Kai candidates is question pe freeze ho jaate hain ye assume karke ki leadership ke liye people manage karna zaroori hai, lekin early-career roles ke liye, interviewers initiative aur ownership ke signs dhundh rahe hain tumhare assigned tasks se aage. Strong examples: team ko ek clear pattern ki kami thi (jaise error handling) notice karna aur proactively ek propose/document karna; ek naye teammate ko mentor karna bina puche; ek recurring production issue identify karna jise koi priority nahi de raha tha aur khud fix drive karna; ya ek decision facilitate karna jab team stuck thi options ke beech.",
    interviewExplanation:
      "I'd give a concrete initiative example: 'Our team had no consistent pattern for error handling across services, causing inconsistent behavior. Without being asked, I documented a proposed standard, discussed it with the team, and we adopted it — reducing a class of bugs we'd been hitting repeatedly. Nobody assigned this to me; I noticed the gap and drove the fix.'",
    diagramNote:
      "'Noticed something needed doing (unassigned)' → 'Took initiative without being told' → 'Positive outcome from that initiative' — the leadership signal without a formal title.",
    diagramMermaid: `flowchart LR
    A["Noticed something<br/>needed doing (unassigned)"] --> B["Took initiative<br/>without being told"]
    B --> C["Positive outcome<br/>from that initiative"]`,
    realProjectExample:
      "'When a new team member joined mid-project, I proactively created a short onboarding doc covering our CAP project's conventions and walked them through our CDS model, cutting their ramp-up time significantly — nobody assigned this, I just noticed it would help and did it.'",
    interviewTip:
  ...
  },
  {
    ...
    detailedAnswer:
      "In many locations, current salary disclosure isn't legally required, and even where it's asked, you're not obligated to answer directly if you have a legitimate reason not to (like your current salary being below-market for reasons specific to your current employer, which shouldn't anchor what a new role should pay). A professional, non-evasive way to redirect: 'I'd prefer to focus on the value and market rate for this specific role rather than my current compensation, which may not be directly comparable given differences in company/role. Based on my research, I'm targeting a range of X to Y for this position.' This is respectful and professional rather than a flat refusal, while still protecting your negotiating position from being unfavorably anchored to a number that might not reflect your actual market value for the role in question.",
    hindiExplanation:
      "Kai locations mein, current salary disclosure legally required nahi hai, aur jaha bhi poocha jaaye, tum directly answer dene ke liye obligated nahi ho agar tumhare paas ek legitimate reason hai na dene ka (jaise tumhari current salary below-market hai reasons ki wajah se jo specific hain tumhare current employer ke liye). Ek professional, non-evasive tarika redirect karne ka: 'Main is specific role ke value aur market rate pe focus karna prefer karunga apni current compensation ki jagah, jo directly comparable nahi ho sakti company/role mein differences ki wajah se. Apni research ke aadhar pe, main X se Y ka range target kar raha hoon is position ke liye.'",
    interviewExplanation:
      "I'd redirect professionally rather than refuse outright or feel obligated to answer directly: 'I'd prefer to focus on the value and market rate for this specific role, since my current compensation may not be directly comparable given differences in company and role scope. Based on my research, I'm targeting a range of X to Y for this position.' This is respectful, not evasive, while protecting my negotiating position from being anchored unfavorably.",
    diagramNote:
    ...
    revisionNotes: "Asked for current salary: politely redirect to role-specific market research/expectations rather than disclosing (especially if below-market) or refusing awkwardly — a professional, composed technique.",
  },
  {
    id: "hr-q18",
    topic: "Notice Period",
